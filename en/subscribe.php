<?php
// subscribe.php — Beautiful Newsletter Subscription Block (English version)
?>
<section style="padding:100px 5%; background:linear-gradient(135deg, #0a0f1c, #1e2937);">
    <div style="max-width:1100px; margin:auto; text-align:center;">
        ...
        <div style="background:rgba(15,23,42,0.8); border:1px solid rgba(245,158,11,0.3); border-radius:28px; padding:60px 40px; box-shadow:0 25px 60px -15px rgb(0 0 0 / 0.6);">
            ...
            <h2 style="font-size:clamp(2.2rem, 5.5vw, 3rem); color:#f59e0b; margin-bottom:16px;">Subscribe to Our Newsletter</h2>
           
            <p style="font-size:1.25rem; color:#cbd5e1; max-width:680px; margin:0 auto 35px; line-height:1.6;">
                Be the first to know about new projects, special offers, useful tips on outdoor advertising and exclusive promotions.
            </p>
            
            <form action="/en/subscribe-handler.php" method="POST" style="max-width:520px; margin:0 auto; display:flex; flex-direction:column; gap:16px;">
