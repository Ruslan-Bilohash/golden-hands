<?php
// send.php — Contact Form Handler (English version)
...
$phone   = strip_tags(trim($_POST["phone"] ?? "Not provided"));
...
try {
    ...
    <body style="margin:0; padding:0; background:#0f172a; font-family:Arial,sans-serif;">
        <div style="max-width:700px; margin:30px auto; background:#1e2937; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.5);">
            <div style="background:linear-gradient(135deg, #1e2937, #334155); padding:35px; text-align:center;">
                ...
                <p style="color:#94a3b8; margin:8px 0 0;">New request from website</p>
            </div>
            <div style="padding:40px; color:#e2e8f0;">
                <h2 style="color:#f59e0b;">Ticket #' . $ticketNumber . '</h2>
                <table style="width:100%; border-collapse:collapse; margin:25px 0;">
                    <tr style="background:#0f172a;"><td style="padding:14px; font-weight:600; width:35%;">Name:</td><td style="padding:14px;">' . htmlspecialchars($name) . '</td></tr>
                    <tr><td style="padding:14px; font-weight:600;">Email:</td><td style="padding:14px;">' . htmlspecialchars($email) . '</td></tr>
                    <tr style="background:#0f172a;"><td style="padding:14px; font-weight:600;">Phone:</td><td style="padding:14px;">' . htmlspecialchars($phone) . '</td></tr>
                    <tr><td style="padding:14px; font-weight:600;">Date:</td><td style="padding:14px;">' . date("Y-m-d H:i") . '</td></tr>
                </table>
                <h3 style="color:#f59e0b; margin-top:30px;">Client Message</h3>
    ...
    header("Location: /en/contact?status=success");
    exit;
