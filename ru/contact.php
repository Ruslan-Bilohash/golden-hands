...
$pageTitle = 'Контакты Golden Hands — Рекламные конструкции Вильнюс';
$pageDescription = 'Свяжитесь с нами: +370 606 08502, +370 641 09990. Офис в Вильнюсе по адресу Dangerucio g. 7. Персональная консультация на русском, английском и литовском.';
$pageKeywords = 'контакты Golden Hands, рекламные конструкции Вильнюс, изготовление вывесок Вильнюс, контакты реклама Литва';
...
<?php if ($status === 'success'): ?>
    <div style="max-width:800px; margin:40px auto; padding:40px; background:#1e2937; border-radius:20px; text-align:center; border:2px solid #34d399;">
        <h2 style="color:#34d399; font-size:2.2rem;">✅ Ваше сообщение успешно отправлено!</h2>
        <p style="font-size:1.25rem; color:#e2e8f0; margin:20px 0 30px;">
            Спасибо! Мы получили вашу заявку и свяжемся с вами в ближайшее время (обычно в течение 1–2 часов).
        </p>
        <a href="contact.php" style="background:#f59e0b; color:#111827; padding:16px 40px; border-radius:50px; text-decoration:none; font-weight:700;">Отправить ещё одну заявку</a>
    </div>
<?php elseif ($status === 'recaptcha_error'): ?>
    <div style="max-width:800px; margin:40px auto; padding:30px; background:#991b1b; border-radius:20px; text-align:center; color:white;">
        <h3>❌ Ошибка проверки reCAPTCHA</h3>
        <p>Пожалуйста, отметьте галочку "Я не робот" и попробуйте отправить форму ещё раз.</p>
        <a href="contact.php" style="color:white; text-decoration:underline;">← Вернуться к форме</a>
    </div>
<?php endif; ?>
<div style="padding-top:80px; min-height:100vh; background:#05070f;">
    ...
    <section style="padding:130px 5% 90px; text-align:center; background:linear-gradient(rgba(10,15,28,0.88), rgba(10,15,28,0.94)), url('assets/img/contact-bg.webp') center/cover no-repeat;">
        <h1 style="font-size:clamp(2.4rem, 6.5vw, 4.5rem); color:white; margin-bottom:20px;">Свяжитесь с нами</h1>
        <p style="font-size:clamp(1.1rem, 4vw, 1.4rem); max-width:780px; margin:auto; color:#cbd5e1;">
            Расскажите о вашем проекте — мы оперативно подготовим индивидуальное предложение
        </p>
    </section>
    ...
    <div style="max-width:1350px; margin:auto; padding:80px 5%; display:grid; grid-template-columns:repeat(auto-fit, minmax(340px,1fr)); gap:60px;">
        ...
        <!-- ЛЕВЫЙ БЛОК - Форма -->
        <div>
            <h2 style="color:#f59e0b; font-size:clamp(2rem, 5vw, 2.5rem); margin-bottom:35px;">Отправить заявку</h2>
            ...
            <form action="send.php" method="POST" style="display:flex; flex-direction:column; gap:22px;">
                ...
                <textarea name="message" rows="7" placeholder="Опишите ваш проект *" required
        ...
        <div>
            <h2 style="color:#f59e0b; font-size:clamp(2rem, 5vw, 2.5rem); margin-bottom:35px;">Контактная информация</h2>
            ...
            <div style="display:flex; flex-direction:column; gap:38px; margin-bottom:50px;">
                <div style="display:flex; gap:22px; align-items:flex-start;">
                    ...
                    <div>
                        <strong style="font-size:1.3rem;">Общий телефон</strong><br>
                        <a href="tel:+37060608502" style="color:#e2e8f0; font-size:1.25rem;">+370 606 08502</a>
						<strong style="font-size:1.3rem;"> Modestas <p style="color:#94a3b8;">🇷🇺 Rusų • 🇱🇹 Lietuvių </p></strong>
                    </div>
                </div>
                <div style="display:flex; gap:22px; align-items:flex-start;">
            ...
            <div style="background:#1e2937; padding:32px; border-radius:20px; margin-bottom:50px;">
                <h3 style="color:#f59e0b; margin-bottom:20px; font-size:1.65rem;">Персональная консультация</h3>
                <div style="display:flex; gap:22px; align-items:flex-start;">
                    <i class="fas fa-user-tie" style="font-size:2.6rem; color:#f59e0b; width:55px;"></i>
                    <div>
                        <strong style="font-size:1.4rem;">Татьяна</strong><br>
                        <span style="color:#94a3b8;">Менеджер по работе с клиентами</span>
            ...
            <!-- Адрес -->
            <div style="background:#1e2937; padding:32px; border-radius:20px; margin-bottom:50px;">
                <h3 style="color:#f59e0b; margin-bottom:20px;">Наш адрес</h3>
                <div>
            ...
            <!-- Карта -->
            <div>
                <h3 style="color:#f59e0b; margin-bottom:18px;">Мы на карте</h3>
